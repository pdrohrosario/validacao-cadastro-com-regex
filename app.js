...
function validaEmail(){
    ...
    //\w ->qualquer caracter de palavra ou noa, \d qualquer numero e \s para qualquer caracter e espaço em branco
...
function validaSenha(){
    ...
    // .* quantos forem os caracteres e o ?= para qualquer posição da string e {6,15} de 6 a quize caracteres
